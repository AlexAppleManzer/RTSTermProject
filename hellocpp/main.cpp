...
public:
  ...
  sciter::string  nativeMessage() { return WSTR("Goodbye C++ World"); }
...
int uimain(std::function<int()> run ) {
  ...
  //  pwin->load( WSTR("file:///home/andrew/Desktop/Project/res/main.htm") ); file:///home/andrew/Desktop/Project/res/main.htm 
